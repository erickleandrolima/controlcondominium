...
<div class="row">
    <div class="col-md-10 col-md-offset-2">
        <h1>{{ Lang::get('permissions.editPermission') }}</h1>
...
{{ Form::model($permission, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('permissions.update', $permission->id))) }}

        <div class="form-group">
            {{ Form::label(Lang::get('permissions.description'), Lang::get('permissions.description'), array('class'=>'col-md-2 control-label')) }}
            <div class="col-sm-10">
              {{ Form::text('permission_description', Input::old('permission_description'), array('class'=>'form-control', 'placeholder'=>'Permission_description')) }}
            </div>
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('permissions.index', Lang::get('app.cancel'), $permission->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
